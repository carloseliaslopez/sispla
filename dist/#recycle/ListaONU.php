    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <main>
                    <div class="container-fluid">
                      <h1 class="mt-4">ONU</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <b>Lista de entidades que no han sido registradas en la lista de riesgo del sistema</b>
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                Listas de riesgo, Persona natural
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="tbl_ctrl_bono" width="100%" cellspacing="0">
                                        ...
                                        <tbody> 
                                            <?php
                                                ...
                                                $xmldata = simplexml_load_file("https://scsanctions.un.org/resources/xml/sp/consolidated.xml") or die("Failed to load"); 

                                                $origen = "ONU";
                                                $fechaingreso = (new DateTime())->format('Y-m-d');
                                                $idEstado = 1;
                                                
                                                foreach($xmldata->INDIVIDUALS->INDIVIDUAL as $key2){
                                                    $test =  $key2->FIRST_NAME." ".$key2->SECOND_NAME." ".$key2->THIRD_NAME." ".$key2->FOURTH_NAME ; 
                                                    $clean = trim($test); 
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                Lista de riesgos, Entidad juridica
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    
                                    <table class="table table-bordered" id="tbl_ctrl_bono2" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
        ...
        <script>
            $(document).ready(function ()
            {
                ...
                successAlert('Éxito', 'La lista consolidad ONU ha sido actualizada');
            });
