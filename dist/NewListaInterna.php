                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12" >
                                                <div class="form-group">
                                                    ...
                                                    type="text" placeholder="Ingrese el nombre de la persona o entidad"  autocomplete="off" required/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    type="text" placeholder="Ingrese la lista restrictiva a la que pertene la persona o entidad" title="Ingrese la lista restrictiva a la que pertene la persona o entidad" autocomplete="off" required/>
                                                </div>
