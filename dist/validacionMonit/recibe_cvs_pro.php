...
foreach ($lineas as $linea) {
    ...
    if ($i != 0) {
        ...
        if( !empty($plastico) ){
            $duplicidad = ("SELECT autorizacion,monto  FROM trx_incoming_pro WHERE autorizacion ='".($autorizacion)."' and  monto ='".($monto)."'");
        ...
        if ( $cant_duplicidad == 0 ) { 
            ...
            $insertarData = "INSERT INTO trx_incoming_pro( 
                    ...
                    <div class="col-lg-12">
                        <div class="card w-50">
                            ...
                            <div class="card-footer text-muted">
                                Bitacoras de transacciones de reportes de incoming  PROFIT-PANAMÁ
                            </div>
                        </div>
                    </div>
                </div>
