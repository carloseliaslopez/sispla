            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Nuevo Perfil Persona-Natural</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Registrando un nuevo Perfil Persona-Natural
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                Formulario para agregar Perfil Persona-Natural
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="txtcategoria" name="txtcategoria" value="Natural"/>
                                                </div>
                                                <div class="form-group">
