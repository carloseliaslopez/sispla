...
//INSTANCIAS
//$datosEmp = new DtControlBonos();
//RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EMPLEADO
$varIdEmp = $_GET['editE'];

$empEdit;
$empEdit = $datosLI->obtenerListaInterna($varIdEmp);
...
<html lang="en">
    ...
    <?php require "../dist/navbar.php" ?>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div style="text-align: right;">
                                        <a href="ListaInterna.php" title="Regresar a la página anterior">
                                            <i class="fas fa-arrow-circle-left"></i>
                                            Regresar
                                        </a>
                                    </div>
                                    <form method="POST" action="../negocio/NgListaInterna.php">
                                        <div class="form-row">
                                            <div class="col-md-12" >
                                                <div class="form-group">
                                                    <label class="small mb-1" ><b>Nombre:</b></label>
                                                    <input type="hidden" name="idli" id="idli" />
                                                ...
                                                <div class="form-group">
                                                    <label class="small mb-1" ><b>Lista Restrictiva:</b></label>
                                                    <input class="form-control py-4" name="origen" id="origen"
                                                    type="text" placeholder="Ingrese la lista restrictiva a la que pertene la persona o entidad" title="Ingrese la lista restrictiva a la que pertene la persona o entidad" autocomplete="off"  disabled required/>
                                                </div>
        ...
        <script>
            ...
            {
                $("#idli").val("<?php echo $varIdEmp ?>");
                $("#nombre").val("<?php echo $empEdit->__GET('nombre') ?>");
                $("#origen").val("<?php echo $empEdit->__GET('origen') ?>");
        ...
        <script>
            function regresar(){
                window.open ("ListaInterna.php","_self")
            }
        </script>
