                ...
                <main>
                    <div class="container-fluid">
                      <h1 class="mt-4">Empleados</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <b>Este apartado administra la gestión de todos Empleados asociados</b>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Agregar nuevas personas o entidades a las lista de Empleados
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card  text-white mb-4" style="background-color:#2B3990;">
                                            ...
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="newEmpleado.php">Agregar elemento</a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="tbl_ctrl_bono" width="100%" cellspacing="0">
                                        ...
                                        <tbody> 
                                            <?php foreach($datosEmp->listarEmpleados() as $r): ?>
                                                <tr>
                                                    <td><?php echo $r->__GET('fechaIngreso'); ?></td>
                                                    <td><?php echo $r->__GET('nombre'); ?></td>
                                                    <td><?php echo $r->__GET('ubicacion'); ?></td>
                                                    <td><?php echo $r->__GET('nombreEmpresa'); ?></td>
                                                   
                                                    <td><?php echo $r->__GET('areaLaboral'); ?></td>
                                                    <td><?php echo $r->__GET('puesto'); ?></td>
                                                                                                        
                                                    <td>
                                                        <a href="editEmpleado.php?editE=<?php echo $r->__GET('idEmpleados'); ?>" 
                                                        ...
                                                        <br>
                                                        <!-- SEGUNDA FORMA -->
                                                        <a href="#" onclick="deleteEmp(<?php echo $r->__GET('idEmpleados'); ?>)" 
