<div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color:#606060;">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="trx_menu" aria-labelledby="headingSix" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="./subirAlertas.php">Cargar Alertas</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="Admin" aria-labelledby="headingFour" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="EstadoClientes.php">Seguimiento de Clientes</a>
